      ...
      <div className="fade-in-down">
        <div className="relative isolate bg-tan rounded-3xl shadow-lg px-6 py-24 sm:py-32 lg:px-8">
          ...
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="text-base/7 font-semibold accent-underline text-brown" style={{ color: 'var(--muted-blue)' }}>Find Us</h2>
            <p className="mt-2 text-5xl font-semibold tracking-tight text-balance text-brown sm:text-6xl">Easily accessible, just as haircuts should be.</p>
          </div>
          <p className="mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-pretty text-brown sm:text-xl/8">Visit us in the heart of Gaithersburg.</p>
