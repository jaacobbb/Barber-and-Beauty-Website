      ...
      <div className="fade-in-down">
        <div className="relative isolate bg-tan rounded-3xl shadow-lg px-6 py-24 sm:py-32 lg:px-8">
          ...
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="text-base/7 font-semibold accent-underline text-brown" style={{ color: 'var(--muted-blue)' }}>Meet Us</h2>
            <p className="mt-2 text-5xl font-semibold tracking-tight text-balance text-brown sm:text-6xl">Get to know your barbers</p>
          </div>
          <p className="mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-pretty text-brown sm:text-xl/8">Our team is dedicated to making you look and feel your best. Meet the barbers who make it happen!</p>
          ...
          <div className="mx-auto mt-16 grid max-w-5xl grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
            {barbers.map((barber, idx) => (
              <div key={barber.name} className="rounded-3xl bg-white/60 p-8 ring-1 ring-gray-900/10 accent-left-bar flex flex-col items-center text-center shadow-lg hover-tilt transition">
                ...
                />
                <h3 className="text-xl font-bold mb-2" style={{ color: 'var(--maroon)' }}>{barber.name}</h3>
