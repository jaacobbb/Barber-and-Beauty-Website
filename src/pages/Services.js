  ...
  return (
    <div className="bg-texture min-h-screen">
      <div className="fade-in-down">
        <div className="relative isolate bg-tan rounded-3xl shadow-lg px-6 py-24 sm:py-32 lg:px-8">
          ...
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="text-base/7 font-semibold accent-underline text-brown" style={{ color: 'var(--muted-blue)' }}>Services</h2>
            <p className="mt-2 text-5xl font-semibold tracking-tight text-balance text-brown sm:text-6xl">We have something for everyone.</p>
          </div>
          <p className="mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-pretty text-brown sm:text-xl/8">Whether it's a small touch up or total makeover, we've got you covered.</p>
          <div className="mx-auto mt-16 grid max-w-lg grid-cols-1 items-center gap-y-6 sm:mt-20 sm:gap-y-8 lg:max-w-4xl lg:grid-cols-2 lg:gap-x-8">
            <div className="rounded-3xl bg-white/60 p-8 ring-1 ring-gray-900/10 sm:p-10 accent-left-bar">
              <h3 id="tier-hobby" className="text-base/7 font-semibold" style={{ color: 'var(--maroon)' }}>Men's Haircut</h3>
              ...
              <ul role="list" className="mt-8 space-y-3 text-sm/6 text-gray-600 sm:mt-10">
                <li className="flex gap-x-3">
                  <svg className="h-6 w-5 flex-none" style={{ color: 'var(--maroon)' }} viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
              ...
              <a href="https://calendly.com/jacoblokheenlee9/30min" target="_blank" rel="noopener noreferrer" aria-describedby="tier-hobby" className="mt-8 block rounded-md px-4 py-3 sm:px-3.5 sm:py-2.5 text-center text-sm font-semibold" style={{ color: 'var(--maroon)', border: '1px solid var(--maroon)' }}>Book an Appointment</a>
            </div>
            <div className="rounded-3xl bg-white/60 p-8 ring-1 ring-gray-900/10 sm:p-10 accent-left-bar">
